...
def load_model(model_path):
    ...
    model =  AutoModelForSpeechSeq2Seq.from_pretrained(model_path,use_safetensors=True,
...
def response_to_audio(audio_url, text=None, model=None, processor=None, temperature = 0, max_new_tokens = 512):
    ...
    audio_array, sample_rate = librosa.load(audio_url, sr=16000)
...
if __name__ == "__main__":
    ...
    # Add arguments
    parser.add_argument('--model_path', type=str, default="MERaLiON/MERaLiON-2-10B", help='Path to the model')
